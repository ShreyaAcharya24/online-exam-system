...
//        Retrieve FK values
        ...
        System.out.println("%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%");
        System.out.println(questionBankRepository.save(newquestion).getQuestionId());
...
//        Prepare Response DTO
    ...
    public QuestionBank findById(int id) {
        return questionBankRepository.findById(id).orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "Question not Found"));
    }
